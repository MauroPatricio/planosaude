 ...
 */
// Note: 10.0.2.2 is the standard for Android emulators. 192.168.0.2 is your current local IP.
const DEV_URL = Platform.OS === 'android' ? 'http://192.168.0.2:5000' : 'http://localhost:5000';
const PROD_URL = 'https://planosaude.nhiquelaservicos.com';
